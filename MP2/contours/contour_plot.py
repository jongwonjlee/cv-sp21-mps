...
FLAGS = flags.FLAGS
flags.DEFINE_list('dirs', ['output/part1', 'output/part2', 'output/part3_sig4', 'output/part4_sig4'], 
                  'List of directories to read metrics from')
flags.DEFINE_list('names', ['part1', 'part2', 'part3_sig4', 'part4_sig4'], 
                  'Legends')
...
def display_results(ax, name, threshold, precision, recall, f1, best_f1, area_pr):
  ...
  label_str = '[{:0.2f}, {:0.2f}, {:0.2f}] {:s}'.format(
